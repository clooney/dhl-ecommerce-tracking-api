DHL eCommerce Tracking API - .Net
================================
Use .Net to track DHL eCommerce shipments with DHL eCommerce Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "4982891432";
                  createTrackingParams.courierCode = "dhlglobalmail";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "8307478620,2967650674";
                  getTrackingResultsParams.courierCode = "dhlglobalmail";
