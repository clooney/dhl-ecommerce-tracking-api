DHL eCommerce Tracking API - Java
================================
Use Java to track DHL eCommerce shipments with DHL eCommerce Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.dhlecommerce;
    ...
    public class CreateDHLeCommerceTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("4982891432");
                createTrackingParams.setCourierCode("dhlglobalmail");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateDHLeCommerceTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("2967650674");
                createTrackingParams1.setCourierCode("dhlglobalmail");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("8307478620");
                createTrackingParams2.setCourierCode("dhlglobalmail");
...
Get status of the shipment:
    ...
    public class GetDHLeCommerceTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("8307478620,2967650674");
                trackingParams.setCourierCode("dhlglobalmail");
...
Update a tracking by ID:
    ...
    public class UpdateDHLeCommerceTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "9b42b6bbbb647005acf63b5ed64f22f0";
